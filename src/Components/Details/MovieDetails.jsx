        ...
        <div>
            ...
            <div className="hero lg:min-h-screen" style={{ backgroundImage: `url(https://image.tmdb.org/t/p/w500${backdrop_path})` }}>
                ...
                <div>
                    ...
                    <div className="flex lg:flex-row flex-col justify-between px-[20px] lg:gap-52 gap-3 mb-10">
                        <img src={`https://image.tmdb.org/t/p/w500${poster_path}`} className="rounded-xl" alt="" />
                        <div>
                            <iframe
                                className="lg:w-[1000px] w-[300px] mx-auto lg:mx-0 h-[400px] lg:h-[500px]"

                                src={`https://www.youtube.com/embed/${videoKey}`}

                                allowfullscreen
                            ></iframe>
                            <div className="space-y-3 lg:w-[1000px] w-[300px] mx-auto">
                                <p className="font-plus font-semibold lg:text-3xl text-xl text-white"> <span className="text-3xl text-red-700 font-semibold mr-2">Title :</span>{title}</p>
                                <p className="font-plus font-semibold lg:text-xl text-sm text-white">{overview}</p>
                                <p className="font-plus font-semibold lg:text-xl text-sm text-white"><span className="text-xl text-red-700 font-semibold">Status :</span>{status}</p>
